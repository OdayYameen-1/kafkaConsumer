...
public class kafkaConf {
	...
	public ConsumerFactory<String, User> consumerFactory(){
		...
		config.put(ConsumerConfig.GROUP_INSTANCE_ID_CONFIG, "mygroup_JSON");
	...
	public ConsumerFactory<String, String> consumerFactoryString(){
		...
		config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,"127.0.0.1:9092");
		config.put(ConsumerConfig.GROUP_ID_CONFIG, "mygroup_String");
		config.put(ConsumerConfig.GROUP_INSTANCE_ID_CONFIG, "mygroup_String");
		config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG,StringDeserializer.class);
	  ...
	  @Bean
	    ...
	    kafkaListenerContainerFactory()  {
	        ...
	        factory.setConsumerFactory(consumerFactory());
			  ...
			  factory.setErrorHandler(new ErrHand());
	  ...
	  @Bean
	    ...
	    kafkaListenerContainerFactoryFOOOOOORString()  {
